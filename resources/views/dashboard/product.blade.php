        ...
        <div class="pt-5">
            <div class="flex justify-end">
                <form action="{{ route('SearchName') }} " method="post">
                    @csrf
                <input type="text" placeholder="Search" name="name" class="border-b border-gray-300">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        ...
        <div class="sm:mt-10 sm:w-390 sm:h-200 shadow-xl mt-5">
            ...
            <tr class="p-3 border-b border-gray-300">
                ...
                <td class="p-1 pr-2 text-center"><a href="{{ route('EditProductUi',['id' => $single_product->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-green-500">
            ...
            <div class="absolute top-225 flex left-420 ">
                <a href="{{ route('NextPage',compact('count'))}}"><p class="text-blue-400">Next</p></a><p class="pl-5">{{$page}}</p><a href="{{ route('BackPage', compact('count')) }}"><p class="pl-5 pr-3 text-blue-400">Back</p></a>
            </div>
            </form>
            <form action="{{ route('AddProduct') }} "enctype="multipart/form-data" class="md:border-l md:border-gray-300 md:pl-20 pl-5 md:mr-85 md:mt-0 mt-20" method="post">
                
                @csrf
                 <h1 class="md:p-6 md:text-base text-xs p-3 font-bold">Add Product</h1>
                <div class="pl-6 pt-2">
                    <input type="text" name="judul" placeholder="Judul" class="border-b border-black ">
                </div>
