  ...
  @endif
     ...
     <body x-data="{open : false}">
      ...
      <div class="p-6 ">
        ...
        <div class="grid grid-cols-4 gap-3 justify-self-center sm:pt-10">
            ...
            <div class="shadow-xl sm:w-64  sm:h-64">
                <h1 class="text-xl p-5 font-bold justify-self-center">Omset</h1>
            ...
            <div class="shadow-xl sm:w-64  sm:h-64">
                <h1 class="text-xl p-5 font-bold justify-self-center">Top 1 Product</h1>
